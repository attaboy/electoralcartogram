...
Party.NDP = new Party("NDP-New Democratic Party/NPD-Nouveau Parti démocratique", "NDP", "NPD", "hsla(34, 96%, 45%, 1.0)", "ndp");
Party.Conservative = new Party("Conservative/Conservateur", "Conservative", "Conservateur", "hsla(214, 63%, 35%, 1.0)", "conservative");
Party.Green = new Party("Green Party/Parti Vert", "Green Party", "Parti vert", "hsla(116, 49%, 41%, 1.0)", "green");
