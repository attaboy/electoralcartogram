    ...
    <g clipPath="url(#_clip1)">
      ...
      <g id="Labels" transform="matrix(0.926829,0,0,1.06522,155.61,50)">
        ...
        <g id="Water">
          ...
          <g transform="matrix(1,0,0,1,78.1276,120.333)">
            <text x="42.872px" y="229.667px" className="waterText">{this.getLabelFor("Lake")}</text>
